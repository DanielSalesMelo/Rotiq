...
console.log("--- CORRIGINDO WORKSPACE E CRIANDO FRONTEND ---");

// Etapa 1: Corrigir o pnpm-workspace.yaml
console.log('\n>> Etapa 1: Corrigindo pnpm-workspace.yaml...');
...
`;
fs.writeFileSync(workspaceYamlPath, workspaceConfig.trim());
console.log('>> pnpm-workspace.yaml corrigido para incluir a pasta "apps".');

// Etapa 2: Limpar a tentativa anterior
console.log('\n>> Etapa 2: Limpando a pasta web-app anterior...');
if (fs.existsSync(webAppPath)) {
    fs.rmSync(webAppPath, { recursive: true, force: true });
    console.log('>> Pasta anterior removida.');
}

// Etapa 3: Criar a estrutura mínima do pacote
console.log('\n>> Etapa 3: Criando estrutura mínima do pacote...');
...
// Etapa 4: Rodar 'pnpm install' para registrar o novo workspace (AGORA VAI FUNCIONAR)
console.log('\n>> Etapa 4: Registrando o novo pacote no workspace...');
run(`pnpm install`);

// Etapa 5: Instalar as dependências
console.log('\n>> Etapa 5: Instalando dependências...');
...
// Etapa 6: Configurar o TailwindCSS
console.log('\n>> Etapa 6: Configurando TailwindCSS...');
...
// Etapa 7: Criar os arquivos do Dashboard
console.log('\n>> Etapa 7: Criando os arquivos do Dashboard...');
...
// Etapa 8: Salvar no GitHub
console.log('\n>> Etapa 8: Salvando progresso no GitHub...');
run('git add .');
...
fs.unlinkSync('create-webapp-the-right-way.cjs');
